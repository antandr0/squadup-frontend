        ...
        <div style={{
          ...
          <AnimatedIcon delay={200}>
            <div style={{
              ...
              <p style={{ color: '#b0b0d0', lineHeight: '1.6' }}>
                Выбирай тиммейтов по рейтингу, оценкам и стилю игры и находи идеальных тиммейтов
              </p>
            </div>
          </AnimatedIcon>
          <AnimatedIcon delay={400}>
            <div style={{
              ...
              <p style={{ color: '#b0b0d0', lineHeight: '1.6' }}>
                Играй с геймерами из своего города с минимальным пингом. Геопоиск с динамическим или статическим диапозоном.
              </p>
            </div>
          </AnimatedIcon>
